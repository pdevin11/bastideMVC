        ...
        <br><br> <!-- ajouter du margin pour virer les br moches -->
            ...
            <form action="" method="post">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="menu_name" name="menu_name" value="<?=$name?>">
                    <p class="commentError"><?=$menu_nameError?></p>
                </div>

                <div class="form-group">
                    <label for="menu_price" class="label_title">Prix du menu :</label>
                    <input type="number" class="form-control" step="0.1" id="menu_price" name="menu_price" value="<?=$price?>">
                    <p class="commentError"><?=$menu_priceError?></p>
                </div>

                <div class="form-group">
                    <input class="btn btn-success" type="submit" name="ajouter" value="Ajouter le menu">
